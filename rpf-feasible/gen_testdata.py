...
pktCnt = 0
pkt1 = Ether(dst=MAC_DST, src=MAC_SRC) / IP(dst=IP_DST1, src=IP_SRC1, ttl=64)
pkt2 = Ether(dst="08:08:08:08:08:08", src=MAC_DST) / IP(dst=IP_DST1, src=IP_SRC1, ttl=63, chksum=0x69c8)
pkt1 = pad_pkt(pkt1, 64)
pkt2 = pad_pkt(pkt2, 64)
applyPkt(pkt1, "nf0", pktCnt)
pktCnt += 1
expPkt(pkt2, "nf1", False)

pkt3 = Ether(dst=MAC_DST, src=MAC_SRC) / IP(dst=IP_SRC1, src=IP_DST1, ttl=64)
pkt4 = Ether(dst="07:07:07:07:07:07", src=MAC_DST) / IP(dst=IP_SRC1, src=IP_DST1, ttl=63, chksum=0x69c8)
pkt3 = pad_pkt(pkt3, 64)
pkt4 = pad_pkt(pkt4, 64)
applyPkt(pkt3, "nf2", pktCnt)
pktCnt += 1
expPkt(pkt4, "nf0", False)

pkt5 = Ether(dst=MAC_DST, src=MAC_SRC) / IP(dst=IP_SRC1, src=IP_DST1, ttl=64)
pkt5 = pad_pkt(pkt5, 64)
applyPkt(pkt5, "nf3", pktCnt)
pktCnt += 1
