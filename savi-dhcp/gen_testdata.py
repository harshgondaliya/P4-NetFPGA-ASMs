...
MAC_SRC = "02:02:02:02:02:02"
MAC_DST = "03:03:03:03:03:03"

IP_SRC1 = "192.168.10.2"
IP_DST1 = "192.168.10.3"

pktCnt = 0
pkt1 = Ether(dst=MAC_DST, src=MAC_SRC) / IP(dst=IP_DST1, src=IP_SRC1)
pkt2 = Ether(dst=MAC_DST, src=MAC_SRC) / IP(dst=IP_DST1, src=IP_SRC1)
...
pkt3 = Ether(dst=MAC_SRC, src=MAC_DST) / IP(dst=IP_SRC1, src=IP_DST1)
pkt3 = pad_pkt(pkt3, 64)
applyPkt(pkt3, 'nf0', pktCnt)
pktCnt += 1
expPkt(pkt3, "none", True)
